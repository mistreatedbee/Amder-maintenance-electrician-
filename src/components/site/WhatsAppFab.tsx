...
export function WhatsAppFab() {
  return (
    <a
      ...
      className="fixed bottom-7 right-7 z-40 inline-flex items-center gap-2 bg-[#1A1916] px-4 py-2.5 text-white transition-colors hover:bg-[#C09A52]"
    >
      ...
      <span className="text-[0.6rem] font-medium uppercase tracking-[0.2em]">WhatsApp</span>
    </a>
  );
}
